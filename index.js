import * as THREE from 'three';
    ...
    //	texture.colorSpace = THREE.SRGBColorSpace;
         ...
         const materials = 
        {	'krwicz': new THREE.MeshStandardMaterial( { color: 0x0f0f2f, envMap: reflectionCube, roughness: 0.1, metalness: 1.0 } ),
            // 'blaszka': new THREE.MeshLambertMaterial( { color: 0xffffff, envMap: reflectionCube } ),
            // 'plyn': new THREE.MeshLambertMaterial( { color: 0xffffff, envMap: refractionCube, refractionRatio: 0.85 } ),
